...
const provider = new HDWalletProvider( //pass two arguments:
  'zero gas grant exhaust remove brush edge fatigue stuff menu only upset', //Account mneumonic
...
const deploy = async () => {
  ...
  console.log('Attempting to deploy from account', accounts[0]); //first account generated from mneumonic
